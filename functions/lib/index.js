            ...
            if (newStage) {
                ...
                if (leadSnap.exists) {
                    await leadRef.update({
                        ...
                        .catch((e) => console.error('[AI Autopilot] CRM update error:', e.message));
                }
                else {
...
exports.completeWhatsappEmbeddedSignup = (0, https_1.onCall)({
    ...
    let accessToken;
    try {
        const tokenRes = await axios_1.default.get('https://graph.facebook.com/v25.0/oauth/access_token', {
    ...
    try {
        await axios_1.default.post(`https://graph.facebook.com/v25.0/${wabaId}/subscribed_apps`, {}, { params: { access_token: accessToken }, timeout: 10000 });
    }
    catch (err) {
        const metaMessage = err?.response?.data?.error?.message || err.message;
    ...
    try {
        const phoneRes = await axios_1.default.get(`https://graph.facebook.com/v25.0/${phoneNumberId}`, {
