  ...
  sdkPromise = new Promise((resolve, reject) => {
    ...
    window.fbAsyncInit = () => {
      window.FB!.init({
        ...
        version: 'v25.0', // v17.0 está deprecada por Meta (causaba "Identificador de aplicación no válido"); v25.0 confirmada funcionando en la herramienta de prueba de Meta
        xfbml: false,
      });
      resolve();
    };
